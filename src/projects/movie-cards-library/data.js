import AppleseedAlpha from './images/AppleseedAlpha';
import FinalFantasySpiritsWithin from './images/FinalFantasySpiritsWithin';
import GhostInTheShell20 from './images/GhostInTheShell20';
import KingsglaiveFinalFantasyXV from './images/KingsglaiveFinalFantasyXV';
import ResidentEvilVendetta from './images/ResidentEvilVendetta';
...
const movies = [
  {
    ...
    rating: 4.5,
    ImagePath: KingsglaiveFinalFantasyXV,
  },
  {
    title: 'Final Fantasy',
    ...
    rating: 4.5,
    ImagePath: FinalFantasySpiritsWithin,
  },
  {
